        ...
        <Row className="justify-content-center">
          ...
          >
            <ProjectCard
              ...
              description="An immersive Yoruba language learning platform built using the MERN stackincludes placement assessment, class automation via Wise.live, and email integration."
              image={Homepic4}
              link="https://rooteancestrallearninghub.com"
              technologies={["React", "Node.js", "Express", "MongoDB", "Resend", "Tailwind"]}
            />
          </Col>
